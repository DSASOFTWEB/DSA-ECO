...
@section('conteudo')
    @php
        ...
        $permissoesIniciais = old('permissions', $user->getAllPermissions()->pluck('name')->all());
        $papeisIniciais = old('roles', $user->getRoleNames()->all());
    @endphp
    ...
    >
        ...
        <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-white/[0.03]">
            <p class="mb-3 text-sm font-medium text-slate-700">Alterar senha <span class="font-normal text-slate-400">(opcional)</span></p>
        ...
        @can('gerenciarPapeis', $user)
            <div>
                ...
                <p class="mt-1 text-xs text-slate-400">Ao marcar/desmarcar um perfil, o pacote de módulos é recalculado. Ajuste fino nos cards abaixo.</p>
