        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03] sm:p-6 lg:col-span-2">
            ...
            <table class="min-w-full text-sm">
                <thead class="text-left text-xs uppercase text-slate-400">
                    <tr><th class="py-2">Competência</th><th>Vencimento</th><th>Valor</th><th>Status</th><th></th></tr>
                </thead>
                <tbody class="divide-y divide-slate-50">
                    ...
                    @empty
                        <tr><td colspan="5" class="py-6 text-center text-slate-400">Nenhuma mensalidade gerada ainda.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
