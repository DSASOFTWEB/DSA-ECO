    ...
    @foreach ($acessos as $acesso)
        <div class="ticket">
            ...
            <div class="lado-esquerda">
                <div class="icone">&#10003;</div>
                <div class="rotulo">Entrada<br>Liberada</div>
            </div>
            ...
            <div class="lado-direita">
                ...
                <div class="nome">{{ $acesso->nomeTitular() }}</div>
                <div class="info">{{ $acesso->dependente_id ? 'Dependente' : 'Titular' }} &middot; {{ $acesso->unidade->nome }}</div>
                <div class="info">Válido em {{ $acesso->registrado_em->format('d/m/Y \à\s H:i') }}</div>
                ...
                <div class="rodape-ticket">Acesso #{{ $acesso->id }} &middot; cliente com plano ativo</div>
            </div>
        </div>
    @endforeach
</body>
