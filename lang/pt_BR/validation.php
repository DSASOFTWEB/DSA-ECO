...
return [
    ...
    | classe de validação. Sem este arquivo (locale pt_BR sem fallback em
    | inglês configurado), toda mensagem de validação da aplicação aparecia
    | como a própria chave crua (ex: "validation.min.string") em vez de um
    | texto legível — isto corrige o problema em todos os formulários.
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Nomes amigáveis dos campos usados pela aplicação
    |--------------------------------------------------------------------------
    |
    | Sem isto, uma mensagem como "O campo email é obrigatório" usaria o
    | nome técnico do campo (em inglês, snake_case) em vez de um rótulo
    ...
    */
    ...
    'attributes' => [
        ...
        'max_dependentes' => 'máximo de dependentes',
        'dias_acesso_semana' => 'dias de acesso por semana',
        'permite_congelamento' => 'permite congelamento',
        'ativo' => 'ativo',
        'sku' => 'SKU',
        ...
        'valor_fechamento_informado' => 'valor informado',
        ...
        'admin_password_confirmation' => 'confirmação de senha',
    ],
